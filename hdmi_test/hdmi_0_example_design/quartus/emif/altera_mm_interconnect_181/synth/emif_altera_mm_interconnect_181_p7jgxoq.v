// emif_altera_mm_interconnect_181_p7jgxoq.v
...
`timescale 1 ps / 1 ps
module emif_altera_mm_interconnect_181_p7jgxoq (
	...
	emif_altera_merlin_master_translator_181_mhudjri #(
		.AV_ADDRESS_W                (16),
		.AV_DATA_W                   (32),
		.AV_BURSTCOUNT_W             (1),
		.AV_BYTEENABLE_W             (4),
	...
	emif_altera_merlin_slave_translator_181_5aswt6a #(
		.AV_ADDRESS_W                   (12),
		.AV_DATA_W                      (32),
		.UAV_DATA_W                     (32),
		.AV_BURSTCOUNT_W                (1),
