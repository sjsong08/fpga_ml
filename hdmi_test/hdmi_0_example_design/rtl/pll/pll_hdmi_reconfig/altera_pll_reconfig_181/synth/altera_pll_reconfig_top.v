...
localparam MIFSTART_ADDR	= 9'b000010000;
...
begin:reconfig
	...
	begin:mif_reconfig // Generate Reconfig with MIF
		...
		assign mif_start = mgmt_byteenable_write & (mgmt_address == MIFSTART_ADDR);
        ...
        altera_iopll_reconfig_mif_reader  
        #(
		...
		altera_iopll_reconfig_core 
        #(
            .FAMILY(device_family),
            .WAIT_FOR_LOCK(WAIT_FOR_LOCK)
        ) iopll_reconfig_core_inst	(
			// Inputs
			.mgmt_clk(mgmt_clk),
