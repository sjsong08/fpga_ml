// nios_cpu_altera_nios2_gen2_181_nplqe7y.v
...
`timescale 1 ps / 1 ps
module nios_cpu_altera_nios2_gen2_181_nplqe7y (
	...
	nios_cpu_altera_nios2_gen2_unit_181_laxt3ta cpu (
		.clk                                 (clk),                                 //   input,   width = 1,                       clk.clk
		.reset_n                             (reset_n),                             //   input,   width = 1,                     reset.reset_n
		.reset_req                           (reset_req),                           //   input,   width = 1,                          .reset_req
		.d_address                           (d_address),                           //  output,  width = 19,               data_master.address
		...
		.i_address                           (i_address),                           //  output,  width = 19,        instruction_master.address
