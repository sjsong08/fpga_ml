	nios_edid_ram_slave_translator #(
		...
		.uav_address       (_connected_to_uav_address_),       //   input,  width = 11, avalon_universal_slave_0.address
		...
		.uav_byteenable    (_connected_to_uav_byteenable_),    //   input,   width = 1,                         .byteenable
		.uav_readdata      (_connected_to_uav_readdata_),      //  output,   width = 8,                         .readdata
		.uav_writedata     (_connected_to_uav_writedata_),     //   input,   width = 8,                         .writedata
		...
		.av_address        (_connected_to_av_address_),        //  output,   width = 8,      avalon_anti_slave_0.address
		.av_write          (_connected_to_av_write_),          //  output,   width = 1,                         .write
		.av_read           (_connected_to_av_read_),           //  output,   width = 1,                         .read
		.av_readdata       (_connected_to_av_readdata_),       //   input,   width = 8,                         .readdata
		.av_writedata      (_connected_to_av_writedata_),      //  output,   width = 8,                         .writedata
