// nios_edid_ram_slave_translator.v
...
module nios_edid_ram_slave_translator #(
	...
	nios_edid_ram_slave_translator_altera_merlin_slave_translator_181_5aswt6a #(
		...
		.uav_address            (uav_address),       //   input,  width = 11, avalon_universal_slave_0.address
		...
		.uav_byteenable         (uav_byteenable),    //   input,   width = 1,                         .byteenable
		.uav_readdata           (uav_readdata),      //  output,   width = 8,                         .readdata
		.uav_writedata          (uav_writedata),     //   input,   width = 8,                         .writedata
		.uav_lock               (uav_lock),          //   input,   width = 1,                         .lock
		.uav_debugaccess        (uav_debugaccess),   //   input,   width = 1,                         .debugaccess
		.av_address             (av_address),        //  output,   width = 8,      avalon_anti_slave_0.address
		.av_write               (av_write),          //  output,   width = 1,                         .write
		.av_read                (av_read),           //  output,   width = 1,                         .read
		.av_readdata            (av_readdata),       //   input,   width = 8,                         .readdata
		.av_writedata           (av_writedata),      //  output,   width = 8,                         .writedata
