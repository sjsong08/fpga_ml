module nios_edid_ram_slave_translator #(
		parameter AV_ADDRESS_W                   = 8,
		parameter AV_DATA_W                      = 8,
		parameter UAV_DATA_W                     = 8,
		parameter AV_BURSTCOUNT_W                = 1,
		parameter AV_BYTEENABLE_W                = 1,
		parameter UAV_BYTEENABLE_W               = 1,
		parameter UAV_ADDRESS_W                  = 11,
		...
		parameter AV_WRITE_WAIT_CYCLES           = 1,
		...
		input  wire [10:0] uav_address,       // avalon_universal_slave_0.address
		...
		input  wire [0:0]  uav_byteenable,    //                         .byteenable
		output wire [7:0]  uav_readdata,      //                         .readdata
		input  wire [7:0]  uav_writedata,     //                         .writedata
		input  wire        uav_lock,          //                         .lock
		input  wire        uav_debugaccess,   //                         .debugaccess
		output wire [7:0]  av_address,        //      avalon_anti_slave_0.address
		output wire        av_write,          //                         .write
		output wire        av_read,           //                         .read
		input  wire [7:0]  av_readdata,       //                         .readdata
		output wire [7:0]  av_writedata,      //                         .writedata
