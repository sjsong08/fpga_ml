...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../rtl/nios/nios.sopcinfo
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x428f0
SOPC_SYSID_FLAG += --sidp=0x428f0
ELF_PATCH_FLAG  += --sidp 0x428f0
