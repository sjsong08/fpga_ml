...
$(MEM_0)_HIERARCHICAL_PATH := cpu_ram
$(MEM_0)_WIDTH := 32
...
.PHONY: cpu_ram
cpu_ram: check_elf_exists $(MEM_INIT_DIR)/$(MEM_0).hex $(HDL_SIM_DIR)/$(MEM_0).dat $(HDL_SIM_DIR)/$(MEM_0).sym
...
$(FLASH_FILES): %.flash: $(ELF)
	$(post-process-info)
	@$(MKDIR) $(@D)
	$(ELF2FLASH) --input=$< --output=$@ --sim_optimize=$(SIM_OPTIMIZE) $(elf2flash_extra_args)
